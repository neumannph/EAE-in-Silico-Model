...
void ParametersInitializer() {
    ...
    params.lambda = 6.0e-1;   //1.4e-2,   // mm²/cells*dia      // production rate of microglia
    ...
    params.alpha = 6.45e-2;    // dia^-1             // pro-inflamatory cytokine decay rate                                  
...
int main() { 
    ...
    double t_final = 40; // TIME INTERVAL
