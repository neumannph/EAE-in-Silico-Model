...
void ParametersInitializer() {
    ...
    params.lambda = 4.3e-1;   // mm²/cells*dia      // production rate of microglia
    params.ni = 2.3e-2;       // cells/pg*ml       // microglia decay rate (estimated)
    params.p = 6.5e-1;       // mm²/cells*dia      // production rate of oligodendrocyte
    params.gamma = 4.0e-2;    // cells/?*dia       // pro-inflamatory cytokine-induced oligodendrocyte damage (estimated)
    params.beta = 6.8e-1;    // pg/cells*dia,      // pro-inflamatory cytokine production rate per microglia               
...
int main() { 
    ...
    double t_final = 50; // TIME INTERVAL
