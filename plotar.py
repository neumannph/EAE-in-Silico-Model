...
# Função para plotar os marcadores de 58 dias
def plotMarkers58Days(ax):
    ax[1].plot(58, 400, label='Pró', marker = '*', color = 'orange', markersize = 10)
    ax[1].plot(58, 2000, label='Anti', marker = '*', color = 'blue', markersize = 10)
