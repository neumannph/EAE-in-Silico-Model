...
def printPicos():
    ...
    microglias = df['Micróglias Basal'].to_numpy()
...
def plot58DaysModel(arquivo):
    ...
    plotMarkers58Days(ax)

    # Plota as Citocinas Pró-Inflamatórias
    ax[1].plot(df_local['Tempo'], df_local['Citocinas Pró-Inflamatórias'], label='Citocinas Pró-Inflamatórias', linewidth=3, color = 'tab:orange')

    # Plota as Citocinas Anti-Inflamatórias
    ax[1].plot(df_local['Tempo'], df_local['Citocinas Anti-Inflamatórias'], label='IL-10', linewidth=3, color = 'tab:blue')
...
print("============= PICOS 21 DIAS =============")
#printPicos()
#plot21DaysModel(arquivo)

print("============= PICOS 58 DIAS =============")
printPicos()

arquivo = 'dados58Dias.csv'
plot58DaysModel(arquivo)
